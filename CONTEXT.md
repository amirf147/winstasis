...
* **Active Workspace Scoping:** `winstasis` only ever sees, saves, and restores windows that exist on the currently active Virtual Desktop. It does not possess omniscient knowledge of inactive desktops.
