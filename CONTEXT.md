...
* **Omniscient Workspace Tracking:** `winstasis` uses official APIs to extract Workspace GUIDs, but relies on undocumented internal APIs (`IVirtualDesktopManagerInternal`) to bypass OS security rules and force cross-process window moves.
